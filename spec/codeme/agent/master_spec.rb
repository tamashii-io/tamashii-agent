...
RSpec.describe Codeme::Agent::Master do
  ...
  describe "#initialize" do
    ...
    it 'creates all components' do
      expect_any_instance_of(described_class).to receive(:create_component).with(Codeme::Agent::Connection, any_args)
      expect_any_instance_of(described_class).to receive(:create_component).with(Codeme::Agent::Buzzer, any_args)
      expect_any_instance_of(described_class).to receive(:create_component).with(Codeme::Agent::CardReader, any_args)
      subject
    end
